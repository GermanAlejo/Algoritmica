 ...
 */
public class GeneradorDeCiudadesAleatorias {
	
	private final int NUM_CITIES = 1000; // Number of cities to generate
	private ArrayList<Point> cities; // List of city coordinates
	public int[][] matrix; // Distance matrix
	public final int MAX_EUCLID = 1000; // Coordinate space max X and max Y
	Random rand; // Random numbers
	private final String OUTPUT_FILENAME = "TSP1000.txt";
	
	public static void main(String[] args) {
		GeneradorDeCiudadesAleatorias tsp = new GeneradorDeCiudadesAleatorias();
	...
	public GeneradorDeCiudadesAleatorias() {
